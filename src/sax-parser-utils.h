...
/*****************************************************************************
 * A buffer for the XML attributes allowing us to translate the &X; entities.
 ****************************************************************************/
typedef struct attrbuf ATTRBUF_T;
struct attrbuf {
  regex_t pattern; // pattern to match the &X; entities
  const xmlChar **attrs;
  int attrs_size;
  char * buffer;
  int buffer_size;
 ...
 ****************************************************************************/
int prog_version_cmp(const struct prog_version *version,
