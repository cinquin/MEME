...
)
{
  ...
  */
  ...
  align_sites(dataset, model, consensus, los[imotif], pv[imotif], outfile);

  // print diagrams of the sites 
  print_site_diagrams(dataset, model, model->imotif, consensus, los, outfile);
...
#endif
#endif
  print_sites(dataset, model, consensus, PRINT_FASTA, "", outfile);
#ifdef DEBUG_PARALLEL
